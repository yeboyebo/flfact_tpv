...
# @class_declaration flfact_tpv_tpv_anularvales #
class flfact_tpv_tpv_anularvales(interna_tpv_anularvales, helpers.MixinConAcciones):
    pass
...
class tpv_anularvales(flfact_tpv_tpv_anularvales, helpers.MixinConAcciones):
    pass
