...
# @class_declaration flfact_tpv_tpv_vales #
class flfact_tpv_tpv_vales(interna_tpv_vales, helpers.MixinConAcciones):
    pass
...
class tpv_vales(flfact_tpv_tpv_vales, helpers.MixinConAcciones):
    pass
